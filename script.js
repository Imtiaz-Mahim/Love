...
function btnclick() {
  ...
  if (
    (crntName1 === previousName1.toLowerCase() && crntName2 === previousName2.toLowerCase()) ||
    (crntName1 === previousName2.toLowerCase() && crntName2 === previousName1.toLowerCase())
  ) {
    return;
  }
